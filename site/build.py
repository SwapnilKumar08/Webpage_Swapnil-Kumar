    ...
    <div data-reveal data-reveal-delay="100">
      <div class="grid" style="gap:14px;">
        <figure class="art art--wide">
          <img src="assets/aerospace-figure-1.png" alt="Aerospace PyFR and Nektar++ sequence forecast panel" loading="lazy" onerror="this.style.display='none'">
          <span class="art__cap">PyFR · Nektar++ · ConvLSTM · PredRNN</span>
        </figure>
        <figure class="art art--wide">
          <img src="assets/aerospace-figure-2.png" alt="Polynomial order and angle of attack CFD figure" loading="lazy" onerror="this.style.display='none'">
          <span class="art__cap">Polynomial order sweep · AoA 1° 3° 5° 7°</span>
        </figure>
        <figure class="art art--wide">
          <img src="assets/aerospace-figure-3.png" alt="PyFR jet condition comparison with CT 0.25 and CT 1.0" loading="lazy" onerror="this.style.display='none'">
          <span class="art__cap">No jet · CT 0.25 · CT 1.0 short penetration mode</span>
        </figure>
      </div>
    </div>
  </div>
